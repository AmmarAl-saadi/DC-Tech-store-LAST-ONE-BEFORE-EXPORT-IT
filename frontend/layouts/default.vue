<template>
  <div :class="routeName">
    ...
    />
    <main class="min-h-[70vh]" style="background:#F5F5F5;font-family:sans-serif;font-size:14px;color:#333333;">
      <slot/>
    </main>
    <CommonFooter/>
...
<script setup>
  ...
  onMounted(() => {
    ...
    if (!localStorage.getItem('popupBannerClosed', false) && parseInt(popupBanner.value?.status) === status.PUBLIC && popupBanner.value?.image) {
