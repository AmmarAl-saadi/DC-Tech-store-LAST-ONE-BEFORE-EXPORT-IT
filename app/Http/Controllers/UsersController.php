...
class UsersController extends ControllerHelper
{
    ...
    public function deleteUser(Request $request)
    {
        try {
            ...
            UserFollowStore::where('user_id', $id)->delete();
    ...
    public function delete(Request $request, $id)
    {
        try {
            ...
            foreach ($ids as $i) {
                ...
                UserFollowStore::where('user_id', $i)->delete();
    ...
    public function profile(Request $request)
    {
        try {
            ...
            if ($request->user('user')) {
                ...
                $user['wishlist'] = UserWishlist::where('user_id', $user->id)->pluck('product_id')
                    ->toArray();

                $user['following'] = UserFollowStore::where('user_id', $user->id)->pluck('store_id')
                    ->toArray();
                unset($user['code']);
